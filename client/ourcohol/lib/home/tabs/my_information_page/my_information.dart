                        ...
                        Container(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () async {
                              ...
                              if (resultImage != null) {
                                await modifyMyInformation('image', resultImage);
                              }
                            },
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                            ...
                            hintText: '1글자 이상 입력',
                            hintStyle: TextStyle(
                                fontSize: 20, color: Color(0xff686868)),
                            filled: true,
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          padding: EdgeInsets.only(
                              right: 40 / 393 * 100.w, left: 40 / 393 * 100.w),
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                              border: Border.all(
                                  width: 1, color: const Color(0xff131313))),
                          child: Column(
                            children: [
                              PopupMenuButton<String>(
                                ...
                                onSelected: (String value) async {
                                  setState(() {
                                    context.read<UserProvider>().type_alcohol =
                                        value;
                                  });
                                  await modifyMyInformation(
                                      'type_alcohol', value);
